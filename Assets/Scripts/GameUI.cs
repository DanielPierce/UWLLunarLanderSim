...
public class GameUI : MonoBehaviour
{
  ...
  void Update()
  {
    ...
    velocityXText.text = "Velo X: " + System.Math.Round(physicsData.velocity.x, 2).ToString() + "m/s";
    velocityYText.text = "Velo Y: " + System.Math.Round(physicsData.velocity.y, 2).ToString() + "m/s";
    ...
    thrustText.text = "Thrust: " + System.Math.Round(landerController.thrust * landerController.throttle, 1).ToString() + "N";
    fuelText.text = "Fuel: " + System.Math.Round(landerController.currentFuelMass, 1).ToString() + "kg";
