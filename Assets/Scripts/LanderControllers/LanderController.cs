    ...
    if (targetObj.gameObject.tag == "FlatTerrain")
    {
      ...
      if (sectimer <= 0)
      {
        ...
        if (velocity <= safeLandingMaxSpeed && landingAngle <= safeLandingAngle)
        {
          ...
          softLandingText.enabled = true;
          softLandingText.text = "Soft landing at " + velocity + " m/s";
        ...
        else if (velocity <= hardLandingMaxSpeed && landingAngle <= safeLandingAngle)
        {
          ...
          hardLandingText.enabled = true;
          hardLandingText.text = "Hard landing at " + velocity + " m/s";
